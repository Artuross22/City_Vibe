...
namespace CityVibe.Migrations
{
    ...
    [Migration("20230123200030_AddSaveEventModel")]
    partial class AddSaveEventModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("City_Vibe.Models.Event", b =>
                {
                    ...
                    b.HasOne("City_Vibe.Models.SaveEvent", "SaveEvent")
                        .WithMany()
                        .HasForeignKey("SaveEventId");
